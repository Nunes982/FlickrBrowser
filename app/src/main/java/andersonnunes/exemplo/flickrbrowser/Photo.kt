...
class Photo(
    var title: String?, var author: String, var authorId: String, var link: String,
    var tags: String, var image: String
) : Parcelable {
...
class Photo(
    var title: String, var author: String, var authorId: String, var link: String,
    var tags: String, var image: String) : java.io.Serializable {
    ...
    @kotlin.jvm.Throws(ObjectStreamException::class)
